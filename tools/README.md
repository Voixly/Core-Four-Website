...
| `node components.js [slug ...]` | Checks the preview alone, at 11 widths, that the shared components hold together: slider arrows clear of the review text, chip labels hugging their own text, accordion answers indented under their title in the same type and a readable colour. Exits non-zero on a fault. |
