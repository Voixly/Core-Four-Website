...
<head>
    ...
    <title>Track your job · Core Four Roofing</title>
...
<body class="login-page">
    <div class="login-card">
        ...
        <p class="lede">Homeowners and property managers — use the invite we emailed you, then sign in here.</p>
        @if($errors->any())
        ...
        <p class="lede" style="margin-top:1.2rem">Office staff? <a href="{{ route('login') }}">Staff portal</a></p>
    </div>
</body>
</html>
